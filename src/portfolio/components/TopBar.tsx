                ...
                <div style={{ position: 'relative', height: '100%' }}>
                    <div
                        ...
                        style={{
                            ...
                            cursor: 'default', background: activeMenu === 'apple' ? 'rgba(255,255,255,0.1)' : 'transparent',
                            borderRadius: '4px'
                        }}
                    >
                        
                ...
                <div style={{ position: 'relative', height: '100%' }}>
                    <div
                        ...
                        style={{
                            ...
                            cursor: 'default', background: activeMenu === 'app' ? 'rgba(255,255,255,0.1)' : 'transparent',
                            borderRadius: '4px'
                        }}
                    >
                        Finder
                    ...
                    <AnimatePresence>
                        {activeMenu === 'app' && <MenuDropdown items={menuItems.app} setActiveMenu={setActiveMenu} />}
                    </AnimatePresence>
                </div>
                ...
                {['File', 'Edit', 'View', 'Go', 'Window', 'Help'].map(menu => (
                    <div key={menu} style={{ position: 'relative', height: '100%' }}>
                        <div
                            ...
                            style={{
                                padding: '0 12px', height: '100%', display: 'flex', alignItems: 'center',
                                cursor: 'default', background: activeMenu === menu.toLowerCase() ? 'rgba(255,255,255,0.1)' : 'transparent',
                        ...
                        <AnimatePresence>
                            {activeMenu === menu.toLowerCase() && <MenuDropdown items={menuItems[menu.toLowerCase() as keyof typeof menuItems]} setActiveMenu={setActiveMenu} />}
                        </AnimatePresence>
                    </div>
                ))}
            </div>
