...
export const translations = {
    en: {
        ...
        about: {
            ...
            bio1: 'Hi! I am Chingiz, a Full Stack Developer and AI Enthusiast.',
            bio2: 'You have a business idea—I have the digital solution for it. With 6+ years of coding experience, I bridge the gap between concept and high-performance product.',
            bio3: 'Focused on cutting-edge tech and AI, I build clean, efficient, and scalable web experiences. Constantly exploring new tools to turn bold visions into reality.',
            bioTitle: 'Bio',
            skills: 'Skills & Tools',
    ...
    ru: {
        ...
        about: {
            ...
            bio1: 'Привет! Я Чингиз — Full Stack разработчик и AI-энтузиаст.',
            bio2: 'У вас есть бизнес-идея — у меня есть цифровое решение для неё. С 6-летним опытом в программировании, я превращаю концепты в высокопроизводительные продукты.',
            bio3: 'Специализируюсь на современных технологиях и ИИ. Создаю чистый, эффективный и масштабируемый веб-опыт. Постоянно изучаю новые инструменты, чтобы воплощать смелые идеи в жизнь.',
            bioTitle: 'Био',
    ...
    kk: {
        ...
        about: {
            ...
            bio1: 'Сәлем! Мен Шыңғыспын — Full Stack әзірлеуші және ИИ әуесқойы.',
            bio2: 'Сізде бизнес-идея бар — менде оның цифрлық шешімі бар. Программалаудағы 6 жылдан астам тәжірибеммен концепцияларды жоғары өнімді өнімдерге айналдырамын.',
            bio3: 'Заманауи технологиялар мен ИИ-ге назар аудара отырып, таза, тиімді және ауқымды веб-тәжірибелер жасаймын. Батыл идеяларды жүзеге асыру үшін үнемі жаңа құралдарды зерттеймін.',
            bioTitle: 'Био',
    ...
    ar: {
        ...
        about: {
            ...
            bio1: 'مرحباً! أنا جنكيز، مطور Full Stack ومتحمس للذكاء الاصطناعي.',
            bio2: 'لديك فكرة عمل — ولدي الحل الرقمي لها. مع أكثر من 6 سنوات من الخبرة في البرمجة، أقوم بتحويل المفاهيم إلى منتجات عالية الأداء.',
            bio3: 'أركز على أحدث التقنيات والذكاء الاصطناعي لبناء تجارب ويب نظيفة وفعالة وقابلة للتطوير. استكشف باستمرار أدوات جديدة لتحويل الرؤى الجريئة إلى واقع.',
            bioTitle: 'السيرة',
    ...
    tr: {
        ...
        about: {
            ...
            bio1: 'Merhaba! Ben Cengiz — Full Stack Geliştirici ve Yapay Zeka Meraklısı.',
            bio2: 'Sizin bir iş fikriniz var — bende bunun dijital çözümü. 6 yılı aşkın programlama deneyimimle, konseptleri yüksek performanslı ürünlere dönüştürüyorum.',
            bio3: 'En modern teknolojilere ve yapay zekaya odaklanarak temiz, verimli ve ölçeklenebilir web deneyimleri inşa ediyorum. Cesur vizyonları gerçeğe dönüştürmek için sürekli yeni araçlar keşfediyorum.',
            bioTitle: 'Biyografi',
